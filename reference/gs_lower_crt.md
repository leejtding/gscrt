...
`gs_lower_crt` is used to calculate the stopping boundaries for a group
sequential trial with 1 or 2-sided futility-only stopping. Code adapted
...
- b:
  ...
  Upper efficacy boundary values for the interim analyses at the
