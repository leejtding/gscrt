...
- data:
  ...
  Simulated binary outcomes. Should be an n x 4 matrix with the columns
...
- stat_type:
  ...
  `2=` randomized sample increments from multinomial distribution
...
- alpha:
  ...
  Type I error, always one-sided. Default value is 0.05.
