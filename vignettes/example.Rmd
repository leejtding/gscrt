...
This article outlines the procedure for calculating the maximum and expected sample sizes and then evaluating the corresponding empirical power via simulation for a parallel group sequential CRT using the gscrt package.
...
Stopping boundaries for the group sequential CRT design can also be visualized.
